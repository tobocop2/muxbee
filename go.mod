module github.com/tobocop2/beetrix
...
replace github.com/element-hq/dendrite => ./_dendrite
...
require (
	...
	github.com/matrix-org/gomatrixserverlib v0.0.0-20250815065806-6697d93cbcba // indirect
